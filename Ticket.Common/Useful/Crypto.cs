...
namespace Azmoon.Common.Useful
{
    public static class Crypto
    {
        ...
        public static string ToEncodeAndHashMD5(this string password)
        {
            ...
            var encrypted = EncodePassword(password, key);
            var md5 = new MD5CryptoServiceProvider();
            var originalBytes = Encoding.Default.GetBytes(encrypted);
            var encodedBytes = md5.ComputeHash(originalBytes);
        ...
        public static string EncryptStringWithKey(this string Message , string key)
        {
            string Passphrase = key;
            byte[] Results;
            System.Text.UTF8Encoding UTF8 = new System.Text.UTF8Encoding();
        ...
        public static string DecryptStringWithKey(this string Message, string key)
        {
            string Passphrase = key;
            byte[] Results;
            System.Text.UTF8Encoding UTF8 = new System.Text.UTF8Encoding();
